...
- 产品购买：[Open Nextion 2.8" Genius Series ESP32-S3 LCD Touchscreen Development Board](https://itead.cc/product/open-nextion-2-8-genius-series-esp32-s3-lcd-touchscreen-development-board/)
...
| 工作温度 | `-20 ~ 70 C` |
| 存储温度 | `-30 ~ 80 C` |
| 重量 | 净重约 `47 g`，毛重约 `100.5 g` |

## 主要特性

- 基于 `ESP32-S3`，适合做带图形界面的联网应用。
- 板载 `2.8"` 电容触摸屏，适合做控制面板、仪表盘和交互终端。
