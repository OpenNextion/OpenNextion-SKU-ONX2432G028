...
![ONX2432G028](<Product Images/ONX2432G028-1.jpg>)
...
| Weight | Net weight about `47 g`, gross weight about `100.5 g` |

## Key Features

- Built on `ESP32-S3` for connected applications with graphical user interfaces.
- Onboard `2.8"` capacitive touch display, suitable for control panels, dashboards, and interactive terminals.
...
- Supports Li-ion battery power and RTC backup battery, useful for portable and offline-clock scenarios.
